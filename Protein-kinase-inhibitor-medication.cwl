...
steps:
  ...
  protein-kinase-inhibitor-medication-400mg---primary:
    run: protein-kinase-inhibitor-medication-400mg---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  protein-kinase-inhibitor-medication-pazopanib---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: protein-kinase-inhibitor-medication-400mg---primary/output
